...
public class BaseAppCompatActivity  extends AppCompatActivity {
    ...
    public void start(Fragment fragment, boolean addToBackStack, Integer frameId) {
        FragmentTransaction tx = getSupportFragmentManager().beginTransaction().replace(frameId, fragment);
        if (addToBackStack) {
